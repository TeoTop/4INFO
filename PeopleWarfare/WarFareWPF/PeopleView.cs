...
namespace WarFareWPF
{
    public class PeopleView : Notifier
    {
        ...
        public PeopleView(PeupleA peuple)
        {
            ...
            {
                case EnumPeuple.ELF: this.Type = "Elf"; this.Src = "res/elf.png"; break;
                case EnumPeuple.NAIN: this.Type = "Nain"; this.Src = "res/nain.png"; break;
                case EnumPeuple.ORC: this.Type = "Orc"; this.Src = "res/orc.png"; break;
            }
        }
